...
class ProductService
{
    ...
    public function handleP15()
    {
        $data = $this->getData();
        $data = $this->processhandleP15($data);
        $data = $this->processhandleP15($data);
        $data = $this->processhandleP15($data);
        $data = $this->processhandleP15($data);
        $data = $this->processhandleP15($data);
    ...
    public function handleZ51()
    {
        $data = $this->getData();
        $data = $this->processhandleZ51($data);
        $data = $this->processhandleZ51($data);
        $data = $this->processhandleZ51($data);
        $data = $this->processhandleZ51($data);
        $data = $this->processhandleZ51($data);
    ...
    public function handleO66()
    {
        $data = $this->getData();
        $data = $this->processhandleO66($data);
        $data = $this->processhandleO66($data);
        $data = $this->processhandleO66($data);
        $data = $this->processhandleO66($data);
        $data = $this->processhandleO66($data);
    ...
    {
        Log::info('[ProductService] ' . $message);
    }
}