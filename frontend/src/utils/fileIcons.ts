...
export function getFileIcon(fileName: string, isDarkMode: boolean = false): string {
	...
	if (lowerFileName === '.gitignore' || lowerFileName === '.gitconfig' || lowerFileName.includes('git')) {
